---
description: >-
  API: Making GET and POST requests through HTTPS to connect with third-party services, interacting with external applications, and accessing or altering data from external sources.
---
