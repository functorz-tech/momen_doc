...
As shown in the diagram, the【Mutation - Update New】action is configured for the confirm button. In this action, the corresponding data column is bound to the content obtained from the【Input Box】,【Current User Data】, etc. When the confirm button is clicked, the input operation is triggered, saving the obtained data to the database.
