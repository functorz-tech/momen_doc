...
description: >-
  ...
  field customization, relationship managemen
---
...
> In the post table, add title (Text), content (Text), cover (Image), and show\_at (Zoned datetime).
...
* Error Type 3: **unique\_constraint\_violation** The imported data contains data that violates constraint restrictions. If your table has a one-to-one relation or other manually set constraints, you need to check that the import content of the constrained fields is unique and does not already exist in the backend.
