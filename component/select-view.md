---
description: >-
  Select View: Typically used for making single or multiple selections from various options. Common examples include selecting categories or choosing answers.
---
